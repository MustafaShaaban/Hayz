...
if( ! defined( 'RARA_BUSINESS_THEME_VERSION' ) ) define( 'RARA_BUSINESS_THEME_VERSION', $theme_data->get( 'Version' ) );
if( ! defined( 'RARA_BUSINESS_THEME_NAME' ) ) define( 'RARA_BUSINESS_THEME_NAME', $theme_data->get( 'Name' ) );
if( ! defined( 'RARA_BUSINESS_THEME_TEXTDOMAIN' ) ) define( 'RARA_BUSINESS_THEME_TEXTDOMAIN', $theme_data->get( 'TextDomain' ) );
