...
<div class="row thim-loginpage" id="customer_login">
    ...
    <div class="col-xs-12 login-area" id="panel-login">
        ...
        <div class="text-center bottom-link">
            <p>
                <a href="<?php echo esc_attr( tp_event_login_url() ) ?>"><?php esc_html_e( 'Login', 'resca' ); ?></a> | <a href="<?php echo esc_attr( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Forgot password?', 'resca' ) ?></a>
            </p>
        </div>
