...
<div class="entry-register">
    ...
    <ul class="event-info">
        ...
        <li class="price">
            ...
            <span clsas="detail"><?php printf( '%s', $event->is_free() ? __( 'Free', 'resca' ) : tp_event_format_price( $event->get_price() ) ) ?></span>
        </li>
    </ul>
	...
	<div class="register-inner">
		...
		<?php if ( !is_user_logged_in() ) { ?>
			<span class="inner-notice">
				<?php
				printf( wp_kses( __( '<span class="event_auth_user_is_not_login">You must <a href="%s">Login</a> to Our site to register this event!</span>', 'resca' ), array( 'a' => array( 'href' => array() ), 'br' => array() ) ), esc_url( tp_event_login_url() ) . '?redirect_to=' . esc_url( tp_event_get_current_url() ) );
				return;
				?>
			</span>
		<?php } ?>
