...
class TitanFrameworkPlugin {
    ...
    public function pluginLinks($plugin_meta, $plugin_file) {
        if ($plugin_file == plugin_basename(__FILE__)) {
            $plugin_meta[] = sprintf("<a href='%s' target='_blank'>%s</a>", "http://www.titanframework.net/docs", __("Documentation", 'thim' )
            );
            $plugin_meta[] = sprintf("<a href='%s' target='_blank'>%s</a>", "https://github.com/gambitph/Titan-Framework", __("GitHub Repo", 'thim' )
            );
            $plugin_meta[] = sprintf("<a href='%s' target='_blank'>%s</a>", "https://github.com/gambitph/Titan-Framework/issues", __("Issue Tracker", 'thim' )
            );
        }
        return $plugin_meta;
    }
