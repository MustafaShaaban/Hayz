...
class CountryList
{
    ...
    {
        return !MoUtility::isBlank(get_mo_option('default_country_code'))
    ...
    {
        return !MoUtility::isBlank(get_mo_option('default_country_code'))
                    && $value === get_mo_option('default_country_code');
	}
	...
	{
		return !MoUtility::isBlank(get_mo_option('default_country'))
