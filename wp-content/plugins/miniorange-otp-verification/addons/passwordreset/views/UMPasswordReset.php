                                        ...
                                        <td>
                                            <div class="mo_otp_form" style="text-align: left;">
                                                <input  type="checkbox" '.$disabled.' 
                                                        ...
                                                        class="app_enable" '.$umpr_enabled.' 
                                                        name="mo_customer_validation_um_pr_enable" />
                                                <strong>'. $form_name . '</strong>
                                                <div    class="mo_registration_help_desc"  '.$umpr_hidden.' 
                                                        id="um_pr_options">                                              
                                                    <p>
                                                        <input  type="radio" '.$disabled.' 
                                                                ...
                                                                class="app_enable"
                                                                value="'.$umpr_type_phone.'" 
                                                                '.( $umpr_enabled_type == $umpr_type_phone ? "checked" : "").' />
                                                        <strong>'. mo_( "Enable Phone Verification" ).'</strong>
                                                    </p>
                                                    <div    '.($umpr_enabled_type != $umpr_type_phone ? "hidden" :"").'
...
echo'							                            : <input    class="mo_registration_table_textbox"
                                                    ...
                                                    <p>
                                                        <input  type="radio" '.$disabled.' 
                                                                ...
                                                                class="app_enable" 
                                                                name="mo_customer_validation_um_pr_enable_type" 
                                                                value="'.$umpr_type_email.'"
                                                                '.( $umpr_enabled_type == $umpr_type_email ? "checked" : "").' />
