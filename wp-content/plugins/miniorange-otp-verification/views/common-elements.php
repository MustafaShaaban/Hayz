...
function get_plugin_form_link($formalink)
{
    if(MoUtility::sanitizeCheck('formLink',$formalink)) {
        echo '<a    class="dashicons mo-form-links dashicons-feedback" 
                    href="' . $formalink['formLink'] . '" 
                    title="' . $formalink['formLink'] . '"
                    id="formLink"  
                    target="_blank">'.
                '<span class="link-text">'.mo_("FormLink").'</span>'.
             '</a>';
    }
    if(MoUtility::sanitizeCheck('guideLink',$formalink)) {
        echo '<a    class="dashicons mo-form-links dashicons-book-alt" 
                    href="' . $formalink['guideLink'] . '" 
                    title="Instruction Guide"
                    id="guideLink" 
                    target="_blank">'.
                '<span class="link-text">'.mo_("Setup Guide").'</span>'.
             '</a>';
    }
    if(MoUtility::sanitizeCheck('videoLink',$formalink)) {
        echo '<a    class="dashicons mo-form-links dashicons-video-alt3" 
                    href="' . $formalink['videoLink'] . '" 
                    title="Tutorial Video"
                    id="videoLink"  
                    target="_blank">'.
                '<span class="link-text">'.mo_("Video Tutorial").'</span>'.
             '</a>';
    }
    echo  '<br/><br/>';
}
