...
echo'	<div class="mo-modal-backdrop">
            ...
            <div class="mo_registration_support_layout static" id="support_form" hidden>
                ...
                <p>'.mo_("Need any help? Just send us a query and we will get in touch.").'</p>
                    <form name="f" method="post" action="">
                        <input type="hidden" name="option" value="mo_validation_contact_us_query_option"/>
                            <div class="mo_support_input_container mo_support_input_half">
                                ...
                                <input type="email" class="mo_support_input" id="query_email" name="query_email" value="'.$email.'" 
                                    placeholder="'.mo_("Enter your Email").'" required />
                            </div>
                            <div class="mo_support_input_container mo_support_input_half">
                                <span class="mo_support_input_label">Your Phone Number</span>
                                <input type="text" class="mo_support_input" name="query_phone" id="query_phone" value="'.$phone.'" 
                    ...
                    <p>You can also leave us a mail at <span class = "mo_support_input_label_highlight">'.$support.'</span></p>
            </div>
        </div>
