...
echo'		<div class="mo_otp_form" id="'.get_mo_class($handler).'">
		        <input  type="checkbox" '.$disabled.' 
                        ...
                        value="1" '.$cf7_enabled.' /><strong>'. $form_name . '</strong>';
...
echo'			<div class="mo_registration_help_desc" '.$cf7_hidden.' id="cf7_contact_options">
                    ...
                    <div '.($cf7_enabled_type != $cf7_type_email ? "hidden" :"").' class="mo_registration_help_desc" 
                            ...
                            <ol>
                                <li>
                                    <a href="'.$page_list.'" target="_blank">'. mo_( "Click Here").'</a> '.
                                ...
                                <li>'. mo_( "Enter the name of the email field below").': <input class="mo_registration_table_textbox" id="mo_customer_validation_cf7_email_field_key" name="mo_customer_validation_cf7_email_field_key" type="text" value="'.$cf7_field_key.'">
