...
echo'			<div class="mo_otp_form" id="'.get_mo_class($handler).'">
                    ...
                    <div class="mo_registration_help_desc" '.$classify_hidden.' id="classify_options">			
                        <p>
                            <input  type="radio" 
                                    '.$disabled.' 
                                    id="classify_email" 
                                    ...
                                    value="'.$classify_type_email.'"
                                    '.( $classify_enabled_type == $classify_type_email ? "checked" : "").' />
                                <strong>'. mo_( "Enable Email Verification").'</strong>
                        </p>							
                        <div    '.($classify_enabled_type != $classify_type_email ? "hidden" :"").' 
                        ...
                        <p>
                            <input  type="radio" '.$disabled.' 
                                    ...
                                    name="mo_customer_validation_classify_type" 
                                    value="'.$classify_type_phone.'"
                                    '.( $classify_enabled_type == $classify_type_phone ? "checked" : "").' />
                                <strong>'. mo_( "Enable Phone Verification").'</strong>
                        </p>
                    
                        <div    '.($classify_enabled_type != $classify_type_phone ? "hidden" :"").' 
