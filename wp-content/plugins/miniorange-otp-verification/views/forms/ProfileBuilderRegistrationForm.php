...
echo' 	<div class="mo_otp_form" id="'.get_mo_class($handler).'"><input type="checkbox" '.$disabled.' id="pb_default" class="app_enable" name="mo_customer_validation_pb_default_enable" value="1" data-toggle="pb_default_options"
			'.$pb_enabled.' /><strong>'. $form_name .'</strong>';
	...
	echo'	<div class="mo_registration_help_desc" '.$pb_hidden.' id="pb_default_options">
				...
				<div '.($pb_enable_type != $pb_reg_type_phone ? "hidden" :"").' id="pb_phone_options" class="pb_form mo_registration_help_desc" >
					<ol>
						...
						<li>'. mo_( "Enter the meta name of your phone field" ).': <input class="mo_registration_table_textbox" id="mo_customer_validation_pb_phone_field_key" name="mo_customer_validation_pb_phone_field_key" type="text" value="'.$pb_phone_key.'"></li>
					</ol>
				</div>
				<p>
...
echo '			</p>
				<div '.($pb_enable_type != $pb_reg_type_both ? "hidden" :"").' id="pb_both_options" class="pb_form mo_registration_help_desc" >
					<ol>
						...
						<li>'. mo_( "Keep track of the Meta Name of the phone field as you will need it later on." ).'</li>
						<li>'. mo_( "Make sure to mark the phone field as required." ).'</li>
						<li>'. mo_( "Enter the meta name of your phone field" ).': <input class="mo_registration_table_textbox" id="mo_customer_validation_pb_phone_field_key1" name="mo_customer_validation_pb_phone_field_key" type="text" value="'.$pb_phone_key.'"></li>
					</ol>
				</div>
			</div>';
