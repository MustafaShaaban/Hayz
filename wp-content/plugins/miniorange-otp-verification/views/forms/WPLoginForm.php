...
echo'	    <div class="mo_registration_help_desc" '.$wp_login_hidden.' id="wp_login_options">
                 ...
                 <p>
                    <input  type="radio" '.$disabled.'
                            ...
                            value="'.$wp_phone_type.'"
                            '.( $wp_enabled_type == $wp_phone_type ? "checked" : "").' />
                    <strong>'. mo_( "Enable Phone Verification" ).'</strong>
                 </p>
                 <div   '.($wp_enabled_type != $wp_phone_type ? "hidden" :"").'
                        class="mo_registration_help_desc"
                        id="wp_phone_option" '.$disabled.'">
...
echo'					    : <input    class="mo_registration_table_textbox"
                    ...
                    <input  type="checkbox" '.$disabled.' id="wp_login_reg" 
                            name="mo_customer_validation_wp_login_register_phone" value="1"
                        '.$wp_login_enabled_type .' />'.
                        '<strong>'.
                ...
                <p>
                    <input  type="radio" '.$disabled.'
                            ...
                            name="mo_customer_validation_wp_login_enable_type"
                            value="'.$wp_email_type.'"
                            '.( $wp_enabled_type == $wp_email_type ? "checked" : "").' />
                ...
                <p>
                    ...
                    <div class="mo_registration_help_desc" '.$skip_pass_fallback_div.' id="otp_skip_pass_fallback_div">
                        <input  type="checkbox" '.$disabled.'
                                id="otp_skip_pass_fallback"
                                name="mo_customer_validation_wp_login_skip_password_fallback"
                                value="1" '.$skip_pass_fallback.' />
                ...
                <p>
                     <p>
                        <input  type="checkbox" '.$disabled.'
                                ...
                                value="1" '.$otpd_enabled.' />
                        <strong>'. mo_( "Delay OTP Verification" ).'</strong>
                    </p>
                    <div class="mo_registration_help_desc" '.$otpd_enabled_div.' id="otp_delay_time_interval">
                        <p style="margin-left:2%;">
                            <table>
                                <tr>
                                    <td>
                                    ...
                                    <td style="width:50%">
                                        <input  class="mo_registration_table_textbox"
                                                ...
                                                type="text"
                                                value="'.$otpd_time_interval.'"> <b>( in mins )</b>
                                    </td>
                                </tr>    
                            </table>
                        </p>
