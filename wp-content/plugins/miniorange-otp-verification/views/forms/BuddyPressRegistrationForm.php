...
echo'		<div class="mo_otp_form" id="'.get_mo_class($handler).'">
                ...
                <div class="mo_registration_help_desc" '.$bbp_hidden.' id="bbp_default_options">
					<p>
					    <input  type="checkbox" 
					            '.$disabled.' 
					            class="form_options" 
