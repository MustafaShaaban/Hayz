						...
						<td>
							<h3>
								...
								<span style="float:right;margin-top:-10px;">
									...
									<span class="dashicons dashicons-arrow-up toggle-div" data-show="false" data-toggle="email_message"></span>
								</span>
							</h3><hr/>
							...
							<h3>
								...
								<span style="float:right;margin-top:-10px;">
									<input type="submit" '.$disabled.' name="save" id="ov_settings_button" 
										class="button button-primary button-large" 
										value="'.mo_("Save Settings").'"/>
									<span class="dashicons dashicons-arrow-up toggle-div" data-show="false" data-toggle="sms_message"></span>
								</span>
							</h3><hr/>
							...
							<h3>
								...
								<span style="float:right;margin-top:-10px;">
									<input type="submit" '.$disabled.' name="save" id="ov_settings_button" 
										class="button button-primary button-large" 
										value="'.mo_("Save Settings").'"/>
									<span class="dashicons dashicons-arrow-up toggle-div" data-show="false" data-toggle="common_message"></span>
								</span>
							</h3><hr/>
